...
data_paths = {
    ...
    'medical_dataset':
    "/filer/tmp1/xh172/ukbb/train_extracted/"
}
...
class TrainConfig(BaseConfig):
    ...
    def make_dataset(self, path=None, **kwargs):
        if self.data_name == 'ffhqlmdb256':
            ...
            return MedicalDataset(path="/filer/tmp1/xh172/ukbb/train_extracted/",image_size=self.img_size,**kwargs)
        elif self.data_name== 'medical_dataset_latent':
            return MedicalDatasetWithLatent(path="/filer/tmp1/xh172/ukbb/train_extracted/",image_size=self.img_size,path_to_latent="/filer/tmp1/xh172/ukbb_latent_code/",**kwargs)
        elif self.data_name== 'medical_dataset_label':
            return MedicalDatasetWithLabel(path="/filer/tmp1/xh172/ukbb/train_extracted/",image_size=self.img_size)
        else:
            raise NotImplementedError()
