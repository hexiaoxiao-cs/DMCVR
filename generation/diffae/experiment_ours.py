        ...
        with writer:
            for batch in tqdm.tqdm(loader, total=len(loader), desc='infer'):
                with torch.no_grad():
                    ...
                    cond = model.encoder(batch['latent'].to(self.device)) #CHANGED ARIST
    ...
    def training_step(self, batch, batch_idx):
        ...
        with amp.autocast(False):
            ...
            if self.conf.train_mode.require_dataset_infer():
                ...
                imgs, idxs,cond = batch['img'], batch['index'],batch["latent"]
    ...
    def on_train_batch_end(self, outputs, batch, batch_idx: int,
        ...
        if self.is_last_accum(batch_idx):
            ...
            if self.conf.train_mode.require_dataset_infer():
                ...
                imgs = batch['img']
                cond=batch["latent"] #CHANGED ARIST
            self.log_sample(x_start=imgs,cond=cond)
            # breakpoint()
