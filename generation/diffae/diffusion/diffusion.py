...
class _WrappedModel:
    ...
    def forward(self, x, t,t_cond=None, seg_style=None, **kwargs): #CHANGED ARIST
        """
        Args:
        ...
        return self.model(x=x, t=do(t), t_cond=t_cond,seg_style=seg_style, **kwargs) #CHANGED ARIST
